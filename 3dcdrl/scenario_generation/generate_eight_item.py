...
def create_maze(base_filepath, filename, size, cell_size):
    # load the base file
    BASE_WAD = 'eight_item_basefile.wad'
    BASE_CFG = 'eight_item_basefile.cfg'
    ...
    item_tids = [2018, 2019, 2012, 2013, 13, 5, 2015, 2014]
    colors = ['g','r', 'b', 'c', 'm', 'y', '0.5', '0.75']
    details = {} 
    items = []
...
if __name__ == '__main__':
    ...
    BASE_FILEPATH = 'scenarios/custom_scenarios/eight_item5/test/'
    NUM_MAZES = 64
    
    for m in range(NUM_MAZES):
        filename = 'eight_item_maze{:003}.wad'.format(m)
