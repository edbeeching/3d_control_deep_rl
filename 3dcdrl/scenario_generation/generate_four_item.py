...
def create_maze(base_filepath, filename, size, cell_size):
    # load the base file
    BASE_WAD = 'four_item_basefile.wad'
    BASE_CFG = 'four_item_basefile.cfg'
...
if __name__ == '__main__':
    ...
    BASE_FILEPATH = 'resources/scenarios/custom_scenarios/plot_test/'
    NUM_MAZES = 16
    
    for m in range(NUM_MAZES):
        filename = 'four_item_maze{:003}.wad'.format(m)
